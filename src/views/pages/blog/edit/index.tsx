...
import {BlogEdit} from '../../models/BlogEdit';
...
const BlogEdit = () => {
  ...
  const [data, setData] = useState<BlogEdit | null>(null),
    [title, setTitle] = useState(''),
    [slug, setSlug] = useState(''),
    [status, setStatus] = useState(''),
    [content, setContent] = useState(editorState),
    [blogCategories, setBlogCategories] = useState<MultiValue<BlogCategory>>([]),
    [featuredImg, setFeaturedImg] = useState<string | ArrayBuffer | null>(null),
    [imgPath, setImgPath] = useState('banner.jpg');

  useEffect(() => {
    axios.get<BlogEdit>('/blog/list/data/edit').then(res => {
      setData(res.data);
                        ...
                        <div className='border rounded p-2'>
                          ...
                          <div className='d-flex flex-column flex-md-row'>
                            <img
                              ...
                              src={featuredImg ? featuredImg.toString() : ''}
                              alt='featured img'
                              width='170'
                              height='110'
                            />
