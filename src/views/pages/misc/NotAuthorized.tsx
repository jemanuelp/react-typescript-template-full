...
import * as Dark from '../../../../src/assets/images/pages/not-authorized-dark.svg';
import * as Light from '../../../../src/assets/images/pages/not-authorized.svg';
      ...
      <div className='misc-inner p-2 p-sm-3'>
        <div className='w-100 text-center'>
          ...
          <p className='mb-2'>
                        ...
                        IUSR account credentials to access
                        the web pages
                        it serves.
          </p>
          <Button
