...
import * as Dark from '../../../../src/assets/images/pages/verify-email-illustration-dark.svg';
import * as Light from '../../../../src/assets/images/pages/verify-email-illustration.svg';
        ...
        <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
            ...
            <CardText className='mb-2'>
                            We've sent a link to your email address: <span
                className='fw-bolder'>hello@pixinvent.com</span> Please
