  ...
  return (
    <Fragment>
      ...
      <Row>
        ...
        <Col sm='12'>
          <SliderValues direction={isRtl === true
? 'rtl'
: 'ltr'} />
        </Col>
        <Col sm='12'>
          <SliderBehaviour direction={isRtl === true
? 'rtl'
: 'ltr'} />
        </Col>
        <Col sm='12'>
          <SliderScalePips direction={isRtl === true
? 'rtl'
: 'ltr'} />
        </Col>
        <Col sm='12'>
          <SliderColors direction={isRtl === true
? 'rtl'
: 'ltr'} />
        </Col>
        <Col sm='12'>
          <SliderWithInput direction={isRtl === true
? 'rtl'
: 'ltr'} />
        </Col>
      </Row>
      <Row>
        <Col lg='3' md='6' sm='12'>
          <SliderVertical direction={isRtl === true
? 'rtl'
: 'ltr'} />
        </Col>
        <Col lg='3' md='6' sm='12'>
          <SliderConnectUpper direction={isRtl === true
? 'rtl'
: 'ltr'} />
        </Col>
        <Col lg='3' md='6' sm='12'>
          <SliderVerticalTooltip direction={isRtl === true
? 'rtl'
: 'ltr'} />
        </Col>
        <Col lg='3' md='6' sm='12'>
          <SliderVerticalLimit direction={isRtl === true
? 'rtl'
: 'ltr'} />
        </Col>
      </Row>
