...
import Select, {components, OnChangeValue} from 'react-select'; // eslint-disable-line
...
const AddEventSidebar = (props: any) => {
  ...
  const [calendarLabel, setCalendarLabel] =
      useState([{ value: 'Business', label: 'Business', color: 'primary' }]);
  ...
  const GuestsComponent = ({ data, ...props }: any) => {
    return (
      <components.Option {...props}>
  ...
  const handleUpdateEvent = () => {
    if (getValues('title').length) {
      const eventToUpdate = {
        ...
        url,
        display: !allDay ? 'block' : undefined,
        extendedProps: {
          location,
          description: desc,
          guests,
          ...
          >
            ...
            <div className='mb-1'>
              ...
              <Select
                ...
                isClearable={false}
                onChange={(data: OnChangeValue<any, any>) => setCalendarLabel([data])}
                components={{
            ...
            <div className='mb-1'>
              ...
              <Flatpickr
                ...
                onChange={(date: any) => setStartPicker(date[0])}
                value={startPicker}
                options={{
                  enableTime: !allDay,
