...
const UserInfoCard = ({selectedUser}: { selectedUser: IUser }) => {
  ...
  // ** render user img
  const renderUserImg = () => {
    if (selectedUser !== null && selectedUser.avatar && selectedUser.avatar.length) {
      return (
        <img
          height='110'
          width='110'
                ...
                <ul className='list-unstyled'>
                  ...
                  <li className='mb-75'>
                    ...
                    <Badge className='text-capitalize'
                      color={statusColors[
                                                   // eslint-disable-next-line max-len
                                                   selectedUser.status as keyof typeof statusColors
                      ]}>
                      {selectedUser.status}
                    </Badge>
                  </li>
            ...
            <Row className='gy-1 pt-75'>
              ...
              <Col md={6} xs={12}>
                ...
                <Select
                  ...
                  defaultValue={
                    statusOptions[statusOptions.findIndex(
