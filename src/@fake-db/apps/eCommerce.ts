...
const data: IEcommerce = {
  products: [
    ...
    },
    {
      ...
      brand: 'Philips',
      price: 14.99,
      image: require('../../../src/assets/images/pages/eCommerce/9.png'),
      hasFreeShipping: false,
      rating: 4,
    ...
    },
    {
      ...
      brand: 'Apple',
      price: 7999.99,
      image: require('../../../src/assets/images/pages/eCommerce/8.png'),
      hasFreeShipping: false,
      rating: 5,
    ...
    },
    {
      ...
      brand: 'Google',
      price: 129.29,
      image: require('../../../src/assets/images/pages/eCommerce/7.png'),
      hasFreeShipping: true,
      rating: 4,
    ...
    },
    {
      ...
      brand: 'Sharp',
      price: 429.99,
      image: require('../../../src/assets/images/pages/eCommerce/6.png'),
      hasFreeShipping: false,
      rating: 3,
    ...
    },
    {
      ...
      brand: 'Apple',
      price: 999.99,
      image: require('../../../src/assets/images/pages/eCommerce/5.png'),
      hasFreeShipping: false,
      rating: 4,
    ...
    },
    {
      ...
      brand: 'OneOdio',
      price: 49.99,
      image: require('../../../src/assets/images/pages/eCommerce/4.png'),
      hasFreeShipping: true,
      rating: 3,
    ...
    },
    {
      ...
      brand: 'Apple',
      price: 999.99,
      image: require('../../../src/assets/images/pages/eCommerce/3.png'),
      hasFreeShipping: true,
      rating: 4,
    ...
    },
    {
      ...
      brand: 'Apple',
      price: 669.99,
      image: require('../../../src/assets/images/pages/eCommerce/2.png'),
      hasFreeShipping: true,
      rating: 5,
    ...
    },
    {
      ...
      brand: 'Apple',
      price: 339.99,
      image: require('../../../src/assets/images/pages/eCommerce/1.png'),
      hasFreeShipping: true,
      rating: 4,
...
mock.onGet('/apps/ecommerce/products').reply(config => {
  const { q = '', sortBy = 'featured', perPage = 9, page = 1 }: ISearch = config.params;
