...
const data: DataBlog = {
  ...
  blogSidebar: {
    recentPosts: [
      {
        img: require('../../../src/assets/images/banner/banner-22.jpg'),
        title: 'Why Should Forget Facebook?',
        id: 7,
        createdTime: 'Jan 14 2020',
      },
      {
        img: require('../../../src/assets/images/banner/banner-27.jpg'),
  ...
  blogDetail: {
    blog: {
      img: require('../../../src/assets/images/banner/banner-12.jpg'),
      title: 'The Best Features Coming to iOS and Web design',
      avatar: require('../../../src/assets/images/portrait/small/avatar-s-7.jpg'),
      userFullName: 'Ghani Pradita',
